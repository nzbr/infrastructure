...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("desec");
			params.setVersion("0.6.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3ZhbG9kaW0vZGVzZWMiLCJ2ZXJzaW9uIjoiMC42LjEifX0="), c => c.charCodeAt(0)));
